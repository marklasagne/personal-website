      ...
      <>
        ...
        <GridRow>
          <GridColumn>
            ...
            <a href="https://www.cardinalprideproperty.com/" target="_blank" rel="noopener noreferrer"><GridItem title={projects[3].name} image={projects[3].image} description={projects[3].description} id={projects[3].id}/></a>
          </GridColumn>
          <GridColumn>
