...
const headShader = `
  ...
  void main() {
    ...
    vec3 specularColor = keyLightBrightness * vec3(25.0/255.0, 25.0/255.0, 25.0/255.0)  * pow(max(dot(reflect(-lightDirection, vNormal), normalize(vViewPosition)), 0.0), 5.0);
