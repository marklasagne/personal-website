...
import { Row, Image, TextLink, PageContainer, MainFont } from '../../components/PageComponents.js';
      ...
      <PageContainer>
        <motion.div
          ...
          <Row data-aos='fade-up'>
            <img src={JobzenData[0].image} style={{ height: 500, marginTop: '6rem' }} alt="save" />
          </Row>
          <Row data-aos='fade-up'>
